...
#include "Commands/CanandToteAuto.h"
#include "Commands/TwentyPointAuto.h"
#include "Commands/CanGrabAutoGroup.h"
...
void Robot::RobotInit() {
	...
	autoChooser->AddObject("Can and tote Auto", new CanandToteAuto());
	autoChooser->AddObject("Twenty Point Auto", new TwentyPointAuto());
	autoChooser->AddDefault("Can Grabber Auto", new CanGrabAutoGroup());
	SmartDashboard::PutData("Auto Mode Chooser", autoChooser);
	// END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS

	driveBaseSub->pRobot_IMU->ZeroYaw();
	Robot::driveBaseSub->IMU_YAWoffset(0);
