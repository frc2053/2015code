...
void driveCommand::Execute() {
	...
	if(RotateAxis == 0)
	{
		Robot::driveBaseSub->MechDrive(XAxis * speedMulti,YAxis* speedMulti,AutoRotCmd* speedMulti,IMU_Yaw);
	...
	{
		Robot::driveBaseSub->MechDrive(XAxis * speedMulti,YAxis * speedMulti,RotateAxis * speedMulti,IMU_Yaw);
