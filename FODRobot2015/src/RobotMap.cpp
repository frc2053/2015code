...
CANTalon* RobotMap::driveBaseSubFrontRightTalon = NULL;
CANTalon* RobotMap::driveBaseSubFrontLeftTalon = NULL;
CANTalon* RobotMap::driveBaseSubBackRightTalon = NULL;
CANTalon* RobotMap::driveBaseSubBackLeftTalon = NULL;
...
CANTalon* RobotMap::winchTalon = NULL;
...
void RobotMap::init() {
	...
	winchTalon = new CANTalon(3);

	driveBaseSubFrontRightTalon = new CANTalon(6);
	
	
	driveBaseSubFrontLeftTalon = new CANTalon(8);
	
	
	driveBaseSubBackRightTalon = new CANTalon(2);
	
	
	driveBaseSubBackLeftTalon = new CANTalon(9);
